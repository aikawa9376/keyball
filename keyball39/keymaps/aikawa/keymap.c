...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [3] = LAYOUT_universal(
    ...
    CPI_I100 , CPI_D100 , SCRL_DVI , SCRL_DVD , _______  ,                            KC_SCLN  , _______  , _______  , _______  , KC_SLASH ,
    _______, _______, _______, _______, RGB_TOG , RTSEN  ,                            _______  , _______  ,_______,_______,_______, _______
  ),
